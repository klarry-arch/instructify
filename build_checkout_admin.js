  ...
  <div style="display: grid; grid-template-columns: 1fr 380px; gap: 3rem; align-items: start;" id="checkout-grid">
    ...
    <div>
      ...
      <div style="background: white; border: 1px solid #e5e7eb; border-radius: 12px; padding: 2rem;">
        ...
        <button id="submit-btn" style="width: 100%; padding: 1rem; background: #FF4D00; color: white; border: none; border-radius: 8px; font-weight: 800; font-size: 1.1rem; cursor: pointer; box-shadow: 0 4px 6px rgba(234, 88, 12, 0.2); transition: 0.2s;">
          Complete Enrollment
        </button>
      </div>
    </div>
