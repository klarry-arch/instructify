...
if ($subject === '') {
    $subject = $category . ' from ' . $name;
}

// ── 7. Intelligent Email Routing ──────────────────────────────
// Support / Technical enquiries -> support@instructify.co.ke
// Commercial / General / Institutional -> info@instructify.co.ke
$supportCategories = [
    'technical support',
...
echo json_encode([
    ...
    'whatsappUrl'   => 'https://wa.me/254143024416?text=' . rawurlencode("Hello Instructify Kenya, I just submitted an enquiry (Ticket #{$ticketId}).\n*Name:* {$name}\n*Category:* {$category}\n*Subject:* {$subject}"),
    'instantReply'  => "Thank you {$name}! Your enquiry has been routed to our {$recipientName} ({$recipientEmail}) under Ticket #{$ticketId}. We will review and respond promptly.",
